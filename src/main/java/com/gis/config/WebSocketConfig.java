...
//    }
    @Override
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        registry.enableSimpleBroker("/queue", "/topic", "/ride-request"); // Broker dùng để gửi tin nhắn
        registry.setApplicationDestinationPrefixes("/app"); // Prefix cho message từ client
        registry.setUserDestinationPrefix("/user"); // Prefix cho tin nhắn đến user cụ thể
    }
